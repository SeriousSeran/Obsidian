...
- [x] Add first medical topic: [[Medicine/Topics/Community_Acquired_Pneumonia]]
- [x] Add first deidentified clinical case: [[Medicine/Clinical_Cases/Case_001_Shortness_of_Breath]]
- [x] Practice one OSCE station: [[Medicine/OSCE/Respiratory_Examination_Station]]
