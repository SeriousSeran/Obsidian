...
review_needed: true
---
# Money Learning Library

> Learn finance from legal books, open textbooks, and evidence-aware investing principles.
...
| Investopedia | [Investopedia](https://www.investopedia.com/) | Financial dictionary and education | Reference terms and concepts |
| SEC EDGAR | [SEC EDGAR](https://www.sec.gov/edgar/searchedgar/companysearch) | Official company filings | Extract factual data on companies |
...
| The Laws of Wealth | [Harriman House](https://harriman.house/books/the-laws-of-wealth/) | Behavioural guardrails for investors |
| The Simple Path to Wealth | [JL Collins NH](https://jlcollinsnh.com/stock-series/) | Index investing and financial independence | Build a simple long term plan |

## Study Workflow

- [ ] Write current cash-flow map.
...
Money notes are planning material, not financial advice. Any investment, debt, or business decision should stay `review_needed: true` until reviewed.
