...
review_needed: true
---
# Body Learning Library

> Learn body, sleep, movement, and energy through official public-health and evidence-aware sources.
...
| NIH Office of Dietary Supplements | [NIH ODS](https://ods.od.nih.gov/) | Scientific information on dietary supplements | Fact-check supplement claims |

## Study Workflow

- [ ] Track sleep and energy in daily notes for one week.
...
Body notes are not medical advice. Mark health decisions with `review_needed: true` when symptoms, medication, or clinical risk are involved.
